(function () {
  ...
  function rowSection(row, idx) {
    ...
    return [
      ...
      '  </div>',
      '  <div class="row-body">',
      `    <button class="row-scroll-btn left" type="button" data-target="${rowId}" data-dir="left">&#8249;</button>`,
      `    <button class="row-scroll-btn right" type="button" data-target="${rowId}" data-dir="right">&#8250;</button>`,
